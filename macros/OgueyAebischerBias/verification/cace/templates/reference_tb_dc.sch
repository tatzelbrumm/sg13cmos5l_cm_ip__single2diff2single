...
F {}
E {}
T {Template Testbench for DC bias-point analysis - OgueyAebischerBias reference} 120 -830 0 0 0.5 0.5 {}
...
Measures vbp/vbn/vbr and the core reference current via the schematic's own
ammeter Vi1 (hierarchical branch current x1.xbias.vi1).} 400 -230 0 0 0.3 0.3 {}
